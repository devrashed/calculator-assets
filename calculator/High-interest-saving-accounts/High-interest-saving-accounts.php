 ...
 */
 ...
 class Highsavingaccount{

       function __construct()
        {
            add_shortcode('high_saving_accounts', [$this, 'highsavings']);
...
<h3 class="textalign">Best High Interest Savings Accounts in Canada</h3>
...
<div class="sb_wapper"> 
     ...
     <div class="sb_blance_name">Balance</div>
       <div class="sb_blance_input"> 
        ...
        <div class="Icon-inside">
          <input id="blance" name="blance" value="10000" class="textfield">
 ...
 <div class="sb-grid"> 
  ...
  <div class="sb-grid"> 
      ...
      <div class="sb-col-3 text-align text-final"> $0 </div>
      <div class="sb-col-4 text-align text-final" id="eqbank"> $250 </div>
  </div>
   ...
   <div class="sb-grid"> 
      ...
      <div class="sb-col-3 text-align text-final"> $0 </div>
      <div class="sb-col-4 text-align text-final" id="canadian"> $240 </div>
  </div>
   ...
   <div class="sb-grid"> 
      ...
      <div class="sb-col-3 text-align text-final"> $0 </div>
      <div class="sb-col-4 text-align text-final" id="neo"> $225 </div>
  </div>
  ...
  <div class="sb-grid"> 
      ...
      <div class="sb-col-2 text-align text-final"> 2.25% </div>
      <div class="sb-col-3 text-align text-final"> $0 </div>
      <div class="sb-col-4 text-align text-final" id="wyth"> $225 </div>
  </div>
   ...
   <div class="sb-grid"> 
      ...
      <div class="sb-col-3 text-align text-final"> $0 </div>
      <div class="sb-col-4 text-align text-final" id="alter"> $200 </div>
  </div>   
  ...
  <div class="sb-grid">  
      ...
      <div class="sb-col-3 text-align text-final"> $0 </div>
      <div class="sb-col-4 text-align text-final" id="scotis"> $150 </div>
  </div> 
  ...
  <div class="sb-grid">  
      ...
      <div class="sb-col-3 text-align text-final"> $0 </div>
      <div class="sb-col-4 text-align text-final" id="candawestern"> $125 </div>
  </div> 
  ...
  <div class="sb-grid">
      ...
      <div class="sb-col-3 text-align text-final"> $0 </div>
      <div class="sb-col-4 text-align text-final" id="koho"> $120 </div>
  </div> 
  ...
  <div class="sb-grid"> 
      ...
      <div class="sb-col-3 text-align text-final"> $0 </div>
      <div class="sb-col-4 text-align text-final" id="simplefinan"> $40 </div>
  </div> 
